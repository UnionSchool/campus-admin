...
import { CaOverlayHost } from './components/overlay'
import {
...
import { createVueApplication } from './vue-application'
import { CAMPUS_KEY } from './campus'
import { CampusApplication } from './application'
import type { CampusApplicationOptions } from './application'
import { builtInComponents } from '@campus-admin/ui'
import { createLocale, installLocale } from '@campus-admin/locale'
import type { CaLocaleConfig } from '@campus-admin/locale'
 ...
 * 需要类型提示时仍可 `import { ca } from '@campus-admin/core'`。
 */
